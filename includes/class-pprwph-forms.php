          ...
          case 'file':
            ?>
              <?php if (empty($pprwph_value)): ?>
                <p class="pprwph-m-10"><?php esc_html_e('No file found', 'pprwph'); ?></p>
              <?php else: ?>
                <p class="pprwph-m-10">
        ...
        ?>
          <select <?php echo ((array_key_exists('required', $pprwph_input) && $pprwph_input['required'] == 'true') ? 'required' : ''); ?> <?php echo (((array_key_exists('disabled', $pprwph_input) && $pprwph_input['disabled'] == 'true') || $pprwph_disabled_fields) ? 'disabled' : ''); ?> <?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple'] ? 'multiple' : ''); ?> id="<?php echo esc_attr($pprwph_input['id']) . ((array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? '[]' : ''); ?>" name="<?php echo esc_attr($pprwph_input['id']) . ((array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? '[]' : ''); ?>" class="pprwph-field <?php echo array_key_exists('class', $pprwph_input) ? esc_attr($pprwph_input['class']) : ''; ?>" placeholder="<?php echo (array_key_exists('placeholder', $pprwph_input) ? esc_attr($pprwph_input['placeholder']) : ''); ?>" data-placeholder="<?php echo (array_key_exists('placeholder', $pprwph_input) ? esc_attr($pprwph_input['placeholder']) : ''); ?>" <?php echo wp_kses_post($pprwph_parent_block); ?>>
            ...
            <?php if (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']): ?>
              ...
              <?php endforeach ?>
            <?php else: ?>
              <option value="" <?php echo $pprwph_value == '' ? 'selected' : '';?>><?php esc_html_e('Select an option', 'pprwph'); ?></option>
        ...
        ?>
          <div class="pprwph-field pprwph-images-block" <?php echo wp_kses_post($pprwph_parent_block); ?> data-pprwph-multiple="<?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? 'true' : 'false'; ?>">
            <?php if (!empty($pprwph_value)): ?>
              ...
              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-btn-mini pprwph-image-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Edit images', 'pprwph')) : esc_html(__('Edit image', 'pprwph')); ?></a></div>
            <?php else: ?>
              <div class="pprwph-images"></div>

              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-btn-mini pprwph-image-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Add images', 'pprwph')) : esc_html(__('Add image', 'pprwph')); ?></a></div>
            <?php endif ?>
      ...
      case 'video':
        ...
        <div class="pprwph-field pprwph-videos-block" <?php echo wp_kses_post($pprwph_parent_block); ?>>
            <?php if (!empty($pprwph_value)): ?>
              ...
              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-video-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Edit videos', 'pprwph')) : esc_html(__('Edit video', 'pprwph')); ?></a></div>
            <?php else: ?>
              <div class="pprwph-videos"></div>

              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-video-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Add videos', 'pprwph')) : esc_html(__('Add video', 'pprwph')); ?></a></div>
            <?php endif ?>
        ...
        ?>
          <div class="pprwph-field pprwph-audios-block" <?php echo wp_kses_post($pprwph_parent_block); ?>>
            <?php if (!empty($pprwph_value)): ?>
              ...
              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-btn-mini pprwph-audio-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Edit audios', 'pprwph')) : esc_html(__('Edit audio', 'pprwph')); ?></a></div>
            <?php else: ?>
              <div class="pprwph-audios"></div>

              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-btn-mini pprwph-audio-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Add audios', 'pprwph')) : esc_html(__('Add audio', 'pprwph')); ?></a></div>
            <?php endif ?>
        ...
        ?>
          <div class="pprwph-field pprwph-files-block" <?php echo wp_kses_post($pprwph_parent_block); ?>>
            <?php if (!empty($pprwph_value)): ?>
              ...
              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-btn-mini pprwph-file-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Edit files', 'pprwph')) : esc_html(__('Edit file', 'pprwph')); ?></a></div>
            <?php else: ?>
              <div class="pprwph-files"></div>

              <div class="pprwph-text-align-center pprwph-position-relative"><a href="#" class="pprwph-btn pprwph-btn-mini pprwph-btn-mini pprwph-file-btn"><?php echo (array_key_exists('multiple', $pprwph_input) && $pprwph_input['multiple']) ? esc_html(__('Add files', 'pprwph')) : esc_html(__('Add file', 'pprwph')); ?></a></div>
            <?php endif ?>
            ...
            <?php if ($html_multi_fields_length): ?>
              <?php foreach (range(0, ($html_multi_fields_length - 1)) as $length_index): ?>
                <div class="pprwph-html-multi-group pprwph-display-table pprwph-width-100-percent pprwph-mb-30">
                  ...
                  <div class="pprwph-text-align-right">
                    <a href="#" class="pprwph-html-multi-remove-btn"><i class="material-icons-outlined pprwph-cursor-pointer pprwph-tooltip" title="<?php esc_html_e('Remove element', 'pprwph'); ?>">remove</i></a>
                  </div>
                </div>
              <?php endforeach ?>
            <?php else: ?>
              <div class="pprwph-html-multi-group pprwph-mb-50">
                ...
                <div class="pprwph-text-align-right">
                  <a href="#" class="pprwph-html-multi-remove-btn pprwph-tooltip" title="<?php esc_html_e('Remove element', 'pprwph'); ?>"><i class="material-icons-outlined pprwph-cursor-pointer">remove</i></a>
                </div>
              </div>
            <?php endif ?>

            <div class="pprwph-text-align-right">
              <a href="#" class="pprwph-html-multi-add-btn pprwph-tooltip" title="<?php esc_html_e('Add element', 'pprwph'); ?>"><i class="material-icons-outlined pprwph-cursor-pointer pprwph-font-size-40">add</i></a>
            </div>
          </div>
        <?php
        break;
