...
class PPRWPH_Menus {
  public function get_options() {
    ...
    $pprwph_options['pprwph_title'] = [
      ...
      'description' => __('This option sets the title of the main whitepaper archive page, whitepaper pages and navigation menus. By default they will be Whitepaper', 'pprwph'),
    ];
